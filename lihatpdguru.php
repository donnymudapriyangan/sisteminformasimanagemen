		...
		<div class="main-panel">
			<div class="content">
                ...
                <div class="card">
								...
								<div class="card-body"> <h4 class="card-title"><b>DATA SISWA </h4> 
...
<br><br>
		...
		while($d = mysqli_fetch_array($data)){
			...
			<td><?php echo $d['nama']; ?></td>
				...
				<td>
                <a href="lpdguru.php?id=<?php echo $d['id']; ?>"><button class="btn btn-primary btn-sm" ><i class="fa fa-info">
									</button></i></a>
								</td>
			</tr>
			<?php 
