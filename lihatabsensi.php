		...
		<div class="main-panel">
			<div class="content">
				...
				<div class="card">
								...
								<div class="card-body"> <h4 class="card-title"><b>DATA ABSENSI </h4> 
...
<br><br>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tb_pdguru");
	...
	include 'koneksi.php';
	$idkelas = $d['idkelas'];
	$dataa = mysqli_query($koneksi,"select * from tbkelas where idkelas='$idkelas'");
	while($dd = mysqli_fetch_array($dataa)){
		?><?php echo $dd['kelas']; ?><?php 
	}
	?></td>
<td>
...
$dataaa = mysqli_query($koneksi,"SELECT * FROM tbabsen where nis='$nisp' and kehadiran='H'");
...
$dataaa = mysqli_query($koneksi,"SELECT * FROM tbabsen where nis='$nisp' and kehadiran='S'");
//$query = "SELECT jenis, SUM(harga) FROM barang GROUP BY jenis";  
$count = mysqli_num_rows($dataaa);
...
$dataaa = mysqli_query($koneksi,"SELECT * FROM tbabsen where nis='$nisp' and kehadiran='I'");
//$query = "SELECT jenis, SUM(harga) FROM barang GROUP BY jenis";  
$count = mysqli_num_rows($dataaa);
...
$dataaa = mysqli_query($koneksi,"SELECT * FROM tbabsen where nis='$nisp' and kehadiran='A'");
//$query = "SELECT jenis, SUM(harga) FROM barang GROUP BY jenis";  
$count = mysqli_num_rows($dataaa);
