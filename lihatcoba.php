		...
		<div class="main-panel">
			<div class="content">
				...
				<div class="card">
								...
								<div class="card-body"> <h4 class="card-title"><b>DATA PTK </h4> 
									
<br><br>
									<div class="table-responsive">
										<table id="basic-datatables" class="table table-head-bg-primary mt-4" >
											<thead>
												<tr>
												  <th >NO</span></th>
												  <th> MIPA</span></th>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tbsiswalulus");
		while($d = mysqli_fetch_array($data)){
			?>
													<td><?php echo $no++; ?></td>
				<td><?php echo $d['mipa']; ?></td>
				<td><?php echo $d['ips']; ?></td>
                <td><?php echo $d['tahun']; ?></td>
				<td>
					<a href="editsiswalulus.php?id=<?php echo $d['id']; ?>"><button class="btn btn-warning btn-sm" ><i class="fas fa-edit">
									</button></i></a>
                                    
                   <a href="hapussiswalulus.php?id=<?php echo $d['id']; ?> "onclick="return confirm('Yakin Hapus?')" >
                          <button class="btn btn-danger btn-sm" ><i class="fas fa-archive">				</button></i></a>			</td>
			</tr>
			<?php 
		}
		?>
