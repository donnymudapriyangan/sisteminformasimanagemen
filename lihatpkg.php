...
?>
		...
		<div class="main-panel">
			<div class="content">
                ...
                <div class="card">
								...
								<div class="card-body"> <h4 class="card-title"><b>DATA PKG </h4> 
  ...
  <br><br>
										...
										<table class="table table-head-bg-primary mt-4" id="basic-datatables">
											<thead>
												<tr>
												  ...
												  <th width="93%" bgcolor="#0C55B3"><span class="style1">Nama Dokumen</span></th>
											  </tr>
											</thead>
											<tfoot>
											</tfoot>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tbpkg");
		while($d = mysqli_fetch_array($data)){
			?>
												<td><?php echo $no++; ?></td>
				<td><?php echo $d['namapkg']; ?></td>
				</tr>
			<?php 
		}
		?>
