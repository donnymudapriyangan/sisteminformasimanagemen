...
?>
    <!-- End Sidebar -->
		...
		<div class="main-panel">
			<div class="content">
                ...
                <div class="card">
								...
								<div class="card-body"> <h4 class="card-title"><b>DATA PRASARANA </h4> 
 	...
 	<br><br>
										...
										<table class="table table-head-bg-primary mt-4" id="basic-datatables">
											<thead>
                                                ...
                                                <th width="7%">NO</th>
												  ...
												  <th width="28%">Jenis Prasarana</th>
			<th width="24%">Nama Prasarana</th>
			<th width="21%">Kepemilikan</th>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tbprasarana");
		while($d = mysqli_fetch_array($data)){
			?>
												<td><?php echo $no++; ?></td>
				<td><?php echo $d['jenisprasarana']; ?></td>
				<td><?php echo $d['namaprasarana']; ?></td>
				<td><?php echo $d['kepemilikan']; ?></td>
