...
?>
		...
		<div class="main-panel">
			<div class="content">
                ...
                <div class="card">
								...
								<div class="card-body"> <h4 class="card-title"><b>SISWA KULIAH </h4> 
 ...
 <br><br>
									<div class="table-responsive">
									  ...
									  <thead>
												<tr>
												 <th width="7%" bgcolor="#0C55B3"><span class="style3">NO</span></th>
			<th width="29%" bgcolor="#0C55B3"><span class="style3">Nama</span></th>
			<th width="28%" bgcolor="#0C55B3"><span class="style3">Tahun Lulus</span></th>
			<th width="36%" bgcolor="#0C55B3"><span class="style3"> Perguruan Tinggi</span></th>
									    </tr>
											</thead>
											<tfoot>
											</tfoot>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tbsiswakuliah");
		while($d = mysqli_fetch_array($data)){
			?>
												<td><?php echo $no++; ?></td>
				<td><?php echo $d['nama']; ?></td>
				<td><?php echo $d['thnlulus']; ?></td>
				<td><?php echo $d['ntinggi']; ?></td>
