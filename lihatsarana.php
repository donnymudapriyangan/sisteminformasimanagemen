...
?>
    ...
    <!-- End Sidebar -->
		...
		<div class="main-panel">
			<div class="content">
                ...
                <div class="card">
								...
								<div class="card-body"> <h4 class="card-title"><b>DATA SARANA </h4> 
 		...
 		<br><br>
									<div class="table-responsive">
										<table class="table table-head-bg-primary mt-4" id="basic-datatables">
											...
											<thead>
												<tr> <th width="7%">NO</th>
												  <th width="27%">Jenis Sarana</th>
			<th width="23%">Nama Sarana</th>
			<th width="22%">Kepemilikan</th>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tbsarana");
		while($d = mysqli_fetch_array($data)){
			?>
												<td><?php echo $no++; ?></td>
				<td><?php echo $d['jenissarana']; ?></td>
				<td><?php echo $d['namasarana']; ?></td>
