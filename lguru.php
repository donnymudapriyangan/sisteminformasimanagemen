...
?>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">LIHAT PTK </h4>
							  </div>
								<div class="card-body">
	...
	include 'koneksi.php';
	$id = $_GET['id'];
	$data = mysqli_query($koneksi,"select * from daftar_guru where id='$id'");
	while($d = mysqli_fetch_array($data)){
		?>
											<form action="lihatguru.php" method="post" enctype="multipart/form-data">
			<table width="100%" class="table table-bordered">
				<tr>
					<td width="26%">Nama</td>
					<td width="74%"><?php echo $d['nama']; ?></td>
				</tr>
				<tr>
					<td>NUPTK</td>
                ...
                <tr>
                   ...
                   <tr>
					...
					<td>&nbsp;</td>
					<td><input type="submit" value="Kembali" class="btn btn-secondary"></td>
				</tr>		
			</table>
</form>
<?php 
