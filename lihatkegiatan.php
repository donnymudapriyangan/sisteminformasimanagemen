		...
		<div class="main-panel">
			<div class="content">
                ...
                <div class="card">
								...
								<div class="card-body"> <h4 class="card-title"><b>DATA KEGIATAN </h4> 
 ...
 <br><br>
									<div class="table-responsive">
										<table class="table table-head-bg-primary mt-4" id="basic-datatables">
											<thead>
												<tr>
												  <th width="7%" bgcolor="#0C55B3"><span class="style1">NO</span></th>
												  <th width="45%" bgcolor="#0C55B3"><span class="style1">Nama Kegiatan</span></th>
												  <th width="48%" bgcolor="#0C55B3"><span class="style1">Foto Kegiatan</span></th>
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"select * from tbkegiatan");
		while($d = mysqli_fetch_array($data)){
			?>
												<td><?php echo $no++; ?></td>
				<td><?php echo $d['namakegiatan']; ?></td>
				<td><a href="adminlogin/filekegiatan/<?php echo $d['linkdokumen']; ?>" target="_blank"><img src='adminlogin/filekegiatan/<?php echo $d['linkdokumen']; ?>' width="150" height="120"/></a></td>
